...
var singularToPlural = map[string]string{
	...
	"logging":                      "logging",
	keyMeshSeedAddressPort:         "mesh-seed-address-ports",
	"multicast-group":              "multicast-groups",
	"namespace":                    "namespaces",
	"node-address-port":            "node-address-ports",
	keyReportDataOp:                keyReportDataOp,
	keyReportDataOpUser:            keyReportDataOpUser,
	keyReportDataOpRole:            keyReportDataOpRole,
	...
	keyTLSMeshSeedAddressPort:      "tls-mesh-seed-address-ports",

...
func InfoQuiesce(log logr.Logger, policy *aero.ClientPolicy, allHosts []*HostConn, selectedHost *HostConn, ns string) error {
	...
	return c.InfoQuiesce(selectedHost.ID, getHostIDsFromHostConns(allHosts), ns)
}
